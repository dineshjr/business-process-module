...
const PropertiesPanel = ({ selectedElement, onPropertyChange, modeler }) => {
  ...
  useEffect(() => {
    if (selectedElement) {
      const savedProperties = localStorage.getItem(
        `propertiesPanelState_${selectedElement.id}`
      );
      if (savedProperties) {
  ...
  const handleInputChange = (property, value) => {
    ...
    onPropertyChange(property, updatedValue);
  };
  ...
  return (
    <div className="properties-panel">
      <button className="accordion" onClick={() => setIsActive(!isActive)}>
        {selectedElement?.type?.slice(5)} Properties
        <FontAwesomeIcon icon={faCaretDown} rotation={isActive ? 180 : 0} />
      </button>
            ...
            <>
              <div className="property-row">
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleInputChange("allocationType", e.target.value)
                  }
                >
              ...
              <div className="property-row">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange("escalationTime", e.target.value)
                  }
                  min="0"
              ...
              <div className="property-row checkbox-row">
                <label>
                  <input
                    type="checkbox"
                    checked={localProperties.allocationSMS || false} // Ensure it doesn't crash if undefined
                    onChange={(e) =>
                      handleInputChange("allocationSMS", e.target.checked)
                    }
                  />
              ...
              <div className="property-row checkbox-row">
                <label>
                  <input
                    type="checkbox"
                    checked={localProperties.allocationEmail || false} // Ensure it doesn't crash if undefined
                    onChange={(e) =>
                      handleInputChange("allocationEmail", e.target.checked)
                    }
                  />
          ...
          {(selectedElement.type === "bpmn:ExclusiveGateway" ||
            ...
            <div className="property-row">
              ...
              <input
                ...
                onChange={(e) =>
                  handleInputChange("possibleOutcome", e.target.value)
                }
              />
            </div>
          )}
